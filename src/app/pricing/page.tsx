    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto py-20 px-4">
        ...
        <div className="flex justify-center animate-scale-in" style={{ animationDelay: '0.2s' }}>
          <div className="w-full max-w-md rounded-3xl border border-border/50 shadow-soft bg-gradient-card p-8 relative overflow-hidden group hover:shadow-glow transition-all duration-500 hover:scale-105">
